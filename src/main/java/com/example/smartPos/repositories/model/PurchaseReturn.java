...
public class PurchaseReturn {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "purchase_return_seq")
    @SequenceGenerator(name = "purchase_return_seq", sequenceName = "purchase_return_seq", allocationSize = 1)
